...
function Add-DefaultConfig {
    ...
    if (!(Get-Env 'SCOOP')) {
        if ($SCOOP_DIR -ne "C:\Users\s0145768\MyApp\scoop") {
    ...
    if (!(Get-Env 'SCOOP_GLOBAL' -global)) {
        if ((Test-IsAdministrator) -and $env:SCOOP_GLOBAL) {
            ...
            if ($SCOOP_GLOBAL_DIR -ne "C:\Users\s0145768\MyApp\scoop\global") {
...
$SCOOP_DIR = "C:\Users\s0145768\MyApp\scoop"
# Scoop global apps directory
$SCOOP_GLOBAL_DIR = "C:\Users\s0145768\MyApp\scoop\global"
# Scoop cache directory
$SCOOP_CACHE_DIR = "C:\Users\s0145768\MyApp\scoop\cache"
...
$SCOOP_CONFIG_HOME = "C:\Users\s0145768\MyApp\.config"
